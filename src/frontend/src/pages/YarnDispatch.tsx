    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      >
        <DialogContent
          ...
          className="w-screen max-w-screen h-screen max-h-screen rounded-none flex flex-col p-0 gap-0"
        >
          {/* Header */}
      ...
      >
        <DialogContent
          ...
          className="w-screen max-w-screen h-screen max-h-screen rounded-none flex flex-col p-0 gap-0 overflow-y-auto"
        >
          <DialogHeader className="px-6 pt-5 pb-4 border-b border-border/60 flex-shrink-0">
          ...
          >
            ...
            <DialogFooter className="px-6 py-4 border-t border-border/60 flex-shrink-0">
              <Button
                type="button"
                variant="outline"
